...
public partial class SettingsWindow : Window
{
    ...
    private void Appearance_Click(object sender, RoutedEventArgs e) => Show("Darstellung", "Design, Animationen und Orvian-Erscheinungsbild.", AppearancePanel);
    ...
    {
        new PasswordVaultWindow { Owner = this }.ShowDialog();
    }
